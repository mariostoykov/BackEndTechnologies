...
namespace WorkshopAdvanced
{
    ...
    public class BlogManagementTests
    {
        ...
        public void BlogPostLifecycleTest()
        {
            ...
            var deleteBlogPostRespose = client.Execute(deleteBlogPostRequest);

            Assert.That(deleteBlogPostRespose.IsSuccessful, Is.True, "Deleting blog post failed");
            ...
            Assert.That(verifyBlogPostResponse.Content, Is.Null.Or.EqualTo("nuull"), "Blog post still exists after deletion");
        }
    }
}