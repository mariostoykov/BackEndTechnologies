...
namespace WorkshopAdvanced
{
    ...
    public class CouponManagementTests
    {
        ...
        public void CouponLifecycleTest()
        {
            ...
            Assert.That(products.Count, Is.GreaterThanOrEqualTo(2), "Not enough products available for the test");
            ...
            Assert.That(verifyCouponResponse.Content, Is.Null.Or.EqualTo("null"), "Coupon still exists after deletion");
        }
