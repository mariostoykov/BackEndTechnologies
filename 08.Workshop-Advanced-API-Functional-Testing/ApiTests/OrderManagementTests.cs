...
namespace WorkshopAdvanced
{
    ...
    public class OrderManagementTests
    {
        ...
        public void ComplexOrderLifecycleTest()
        {
            ...
            Assert.That(addToCartResponse.IsSuccessful, Is.True, "Adding first product to cart failed");
            ...
            Assert.That(getOrderResponse.IsSuccessful, Is.True, "Failed to retrieve order details");
            ...
            var cancelOrderRequest = new RestRequest($"/user/order/update-order/{orderId}", Method.Put);
