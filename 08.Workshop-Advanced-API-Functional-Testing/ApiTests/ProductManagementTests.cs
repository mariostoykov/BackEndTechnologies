...
namespace WorkshopAdvanced
{
    ...
    public class ProductManagementTests
    {
        ...
        public void ProductLifecycleTest()
        {
            ...
            Assert.That(getProductResponse.IsSuccessful, Is.True, "Failed to retrieve product details");
            Assert.That(getProductResponse.Content, Is.Not.Null.Or.Empty, "Product details are null");
            ...
            Assert.That(verifyDeleteResponse.Content, Is.Null.Or.EqualTo("null"), "Product still exists after deletion");
        }
        ...
        public void ProductRatingsLifecycleTest()
        {
            ...
            Assert.That(getProductListResponse.IsSuccessful, Is.True, "Failed to retrieve product list");
            ...
            Assert.That(addReviewResponse.StatusCode, Is.EqualTo(HttpStatusCode.OK), "Adding rating failed");
        ...
        public void ComplexProductInteractionTest()
        {
            ...
            // Add the selected product to the user wishlist
            var addToWishlistRequest = new RestRequest("/product/wishlist", Method.Put);
            addToWishlistRequest.AddHeader("Authorization", $"Bearer {userToken}");
            addToWishlistRequest.AddJsonBody(new
            {
            ...
            var addToWishlistResponse = client.Execute(addToWishlistRequest);
            Assert.That(addToWishlistResponse.IsSuccessful, Is.True, "Adding product to wishlist failed");
            ...
            Assert.That(removeFromWishlistResponse.IsSuccessful, Is.True, "Removing product from wishlist failed");
        }
    }
}
