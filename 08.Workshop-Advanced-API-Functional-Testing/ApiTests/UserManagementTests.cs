...
namespace WorkshopAdvanced
{
    ...
    public class UserManagementTests
    {
        ...
        public void UserLoginTest()
        {
            ...
            Assert.That(forgotPasswordResponse.IsSuccessful, Is.True, "Forgot password request failed");
            Assert.That(forgotPasswordResponse.Content, Is.Not.Null, "Forgot password response data is null");
        }
        ...
        public void UserSignupLoginUpdateAndDeleteTest()
        {
            ...
            Assert.That(updateUserResponse.Content, Is.Not.Null, "Update response data is null");
